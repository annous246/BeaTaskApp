...
const {parseLink:parseLink,cleanDuration:cleanDuration,errorCheck:errorCheck,getDuration:getDuration,verify:verify}=require('./usefull.js')
...
db.connect(dataBaseKey)
.then(()=>console.log('connected'))
.catch(()=>console.log("database error"))

  
const corsOptions = {
    origin: 'http://localhost:5173.com', // Replace with your frontend's origin

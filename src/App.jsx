...
axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
  ...
  useEffect(()=>{
    axios.get('http://localhost:3000.com/task')
    .then((res)=>{
    ...
    axios.get('http://localhost:3000.com/completedTasks')
    .then((res)=>{
      console.log(res.data.tasks)
  ...
  function addTask(iteminput){
    ...
    axios.post('http://localhost:3000.com/addtask',{data:{task:task}})
    .then((res)=>{
  ...
  function updateTodos(id){
    axios.post('http://localhost:3000.com/updatetask',{data:{taskid:id}})
    .then((res)=>{
  ...
  function deleteTask(DeletedItem){
    axios.delete('http://localhost:3000.com/task',{data:{taskid:DeletedItem.id}})
    .then((res)=>{
      settodoItems((old)=>{
  ...
  function clearTasks(){
    axios.post("http://localhost:3000.com/cleartask",{data:{tasks:todoItems}})
    .then((res)=>{
  ...
  function logout(){
    ...
    axios.post('http://localhost:3000.com/logout').then((res)=>{
      console.log(localStorage.getItem('token'))
